                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <form method="post" action="AddRisultato.php">
                                    ...
                                    <div class="form-outline form-white mb-4">
                                        ...
                                        <input type="text" id="typeEmailX" class="form-control form-control-lg" name="nome"/>
                                    </div>

                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="cognome">Cognome</label>
                                        <input type="text" id="typeEmailX" class="form-control form-control-lg" name="cognome"/>
                                    </div>
